/***************************************************************
 class MegaMillions
 MegaMillions is a subclass of class LotteryGame, and represents
 a MegaMillions lottery game. It inherits methods, and instance 
...
public class MegaMillions extends LotteryGame {
    ...
    public static final int MAXIMUM_PICK = 75;
    public static final int MINIMUM_SPECIAL_PICK = 1;
    public static final int MAXIMUM_SPECIAL_PICK = 15;
    ...
    public String getAmountWon(int ticketNumber) {
        ...
        for (int i = 0;!isFound && i < ticketCount;i++) {
    ...
    public String getQuickPickTicket() {
        ...
        ticketInfo = "\n   MegaMillions:" + ticket[ticketCount].toString();
